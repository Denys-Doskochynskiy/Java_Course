...
public class Zoo {
	...
	public Zoo(String name, int yearOfFoundation, double areaOfTheZoo, double ticketPriceInDolars,
			int numberOfVisitorsPerYear, int numberOfAnimals, boolean theAbilityToFeedAnimals) {
		this.name = name;
		this.yearOfFoundation = yearOfFoundation;
	...
	public String toString() {
		return "Zoo{" + "name='" + name + '\'' + ", yearOfFoundation=" + yearOfFoundation + ", areaOfTheZooInHectares="
				+ areaOfTheZooInHectares + ", ticketPriceInDolars=" + ticketPriceInDolars
				+ ", numberOfVisitorsPerYear='" + numberOfVisitorsPerYear + '\'' + ", numberOfAnimals="
				+ numberOfAnimals + ", theAbilityToFeedAnimals='" + theAbilityToFeedAnimals + '\'' + '}';
	}
	...
	public void resetValues(String name, int yearOfFoundation, double areaOfTheZoo, double ticketPriceInDolars,
			int numberOfVisitorsPerYear, int numberOfAnimals, boolean theAbilityToFeedAnimals) {
		this.name = name;
		this.yearOfFoundation = yearOfFoundation;
		this.areaOfTheZooInHectares = areaOfTheZoo;
